...
namespace crmUrbano.Controllers
{
    ...
    private readonly UserManager<IdentityUser> _userManager;
        ...
        public PagoPlazosController(ILogger<HomeController> logger, ApplicationDbContext context, UserManager<IdentityUser> userManager)
        {
               _logger = logger;
            _context = context;
        ...
        public async Task<IActionResult> PagoPlazos()
        {
